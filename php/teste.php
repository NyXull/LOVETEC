...
$stmt = $pdo->query("SELECT nome_cliente, email, senha, data_nasc, num_cnh, rua, numero_telefone
FROM cliente
...
while ($cliente = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo "<td>" . htmlspecialchars($cliente['email']) . "<br> </td>";
    echo "<td>" . htmlspecialchars($cliente['senha']) . "<br> </td>";
